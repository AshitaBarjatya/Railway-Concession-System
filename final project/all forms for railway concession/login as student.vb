Public Class login_as_student
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ' Dim str1 As String
        Dim str As String
        str = "select * from pswstudent where username='" + TextBox1.Text + "'"
        cmd.CommandText = str
    ...
    Private Sub login_as_student_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
